...
from waterflood_app.models.base import FitData, distance_mask, fit_weights
...
def _fit_sector(
    ...
    data = FitData(sgrid, split, weights=fit_weights(sgrid, cfg), allowed=distance_mask(sgrid, cfg))
